package com.vr.platform.authentication;

import com.vr.platform.authentication.detail.CustomUserDetailsService;
import com.vr.platform.authentication.handler.CustomAuthenticationFailHandler;
import com.vr.platform.authentication.handler.CustomAuthenticationSuccessHandler;
import com.vr.platform.authentication.handler.CustomLogoutSuccessHandler;
import com.vr.platform.authentication.handler.TokenAuthenticationFailHandler;
import com.vr.platform.authentication.provider.CustomDaoAuthenticationProvider;
import com.vr.platform.common.utils.Constant;
import com.vr.platform.config.AuthIgnoreConfig;
import com.vr.platform.interceptor.AuthenticationTokenFilter;
...
public class SecurityConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        permitAll.add("/v3/**");
        permitAll.add("/file/**");
        permitAll.add("/api/guest/**");
        permitAll.add("/api/token/login");
        permitAll.add("/api/sys/code");

...
@EnableOpenApi
@ComponentScan(basePackages = {"com.vr.platform.modules"})
@Configuration
...
//                .apis(RequestHandlerSelectors.basePackage("com.vr.platform.modules"))//按包扫描,也可以扫描共同的父包，不会显示basic-error-controller
